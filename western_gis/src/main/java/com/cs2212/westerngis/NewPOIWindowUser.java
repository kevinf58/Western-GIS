...
/**
 * This window will allow the user to input information to create a new POI.
 * @author Kevin
 */
public class NewPOIWindowUser extends javax.swing.JFrame {
    private int x;
    private int y;
    ...
    /**
     * Creates new form newPOIWindow
     */
    public NewPOIWindowUser(int x, int y, String buildName, String buildFloor) {
        this.x = x;
        this.y = y;
    ...
    /**
     * This method disposes the new user POI window when the 'x' button is pressed
     * @param evt 
     */
    ...
    /**
     * This method replaces the placeholder text in the text box with blank space when the
     * text box is clicked on.
     * @param evt 
     */
    ...
    /**
     * This method replaces the blank space with placeholder text when the text 
     * box is unclicked on.
     * @param evt 
     */
    ...
    /**
     * This method Replaces placeholder text in the text box with blank space when the
     * text box is clicked on.
     * @param evt 
     */
    ...
    /**
     * This method Replaces the blank space with placeholder text when the text box is unclicked on.
     * @param evt 
     */
    ...
    /**
     * This method Replaces the placeholder text in the text box with blank space when
    ...
    /**
     * This method saves a new POI when clicking on "save"
     * @param evt 
     */
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        //Saving all info by creating a new POI object
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewPOIWindowUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewPOIWindowUser(0,0,"","").setVisible(true);
            }
        });
    }
