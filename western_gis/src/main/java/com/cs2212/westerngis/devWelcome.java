...
/**
 * This class is responsible for displaying the welcome window for dev users.
 * @author Vladislav
 */
public class devWelcome extends javax.swing.JDialog {

    /**
     * Creates new form devWelcome
     */
    public devWelcome(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        title.setText("Welcome CodeGenius!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(devWelcome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
